...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    Semantic HTML is informational HTML. It provides valuable information to screen readers, such as <header> and <nav>. These two tags are NOT presentational and become <div>s with browsers that do not support HTML5.
...
4. Explain why git is valuable to a team of developers.
    Git allows developers to contribute to their own individual work or branch without affecting the main branch / version live to the end-user.

5. Define mobile-first design in your own words.
    Mobile-first design is designed for the smartphone, since users nowadays use their mobile more than their desktop to browse websites and read articles.
